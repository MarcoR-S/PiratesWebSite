...
function setup() {
  ...
  for(var c=0;c<boatFrames.length;c++){
    var pos=boatFrames[c].position
    var img = boatSpritesheet.get(pos.x,pos.y,pos.w,pos.h)
    boatAnimation.push(img);
  }

  brokenboatFrames=brokenBoatSpritedata.frames
  for(var c1=0;c1<brokenBoatSpritesheet;c1++){
    var pos1=brokenboatFrames[c].position;
    var img = brokenBoatSpritesheet.get(pos.x,pos.y,pos.h,pos.w);
